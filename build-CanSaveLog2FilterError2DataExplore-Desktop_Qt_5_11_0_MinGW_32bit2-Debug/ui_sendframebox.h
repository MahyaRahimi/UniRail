...
public:
    ...
    void setupUi(QGroupBox *SendFrameBox)
    {
        ...
        frameTypeBox->setObjectName(QStringLiteral("frameTypeBox"));
        ...
        frameIdLabel->setObjectName(QStringLiteral("frameIdLabel"));

        verticalLayout->addWidget(frameIdLabel);

        frameIdEdit = new QLineEdit(SendFrameBox);
        frameIdEdit->setObjectName(QStringLiteral("frameIdEdit"));
